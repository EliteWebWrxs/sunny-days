<footer class="bg-warmGray-900 text-white">
  <div class="container-custom section">
    <div class="grid md:grid-cols-3 gap-8">
      ...
      <!-- Contact Info -->
      <div>
        <h4 class="font-display font-bold text-white mb-4">Get in Touch</h4>
        <ul class="space-y-3">
          <li class="flex items-start space-x-3">
            <svg
              class="w-5 h-5 text-gold mt-0.5 flex-shrink-0"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
            ...
            <div>
              <a
                ...
                class="text-gold hover:text-gold/80 font-semibold text-sm transition-colors"
                >813-433-0688</a
              >
            </div>
          </li>
